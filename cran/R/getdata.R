        ...
        if(CLASSIFICATION == "sitc") {
          if(CHARACTERS == 4) {
            ...
            if(!file.exists(csv_file_4char) | !file.exists(json_file_4char)) {
              ...
              ORIGIN_all_YEAR_4char <- ORIGIN_all_YEAR_4char[, c("year", "product", "group", "product_id", "group_id", "import_val", "export_val")]
              ...
              all_all_YEAR_4char <- all_all_YEAR_4char[, c("year", "product", "group", "product_id", "group_id", "import_val", "export_val")]
              ...
              ORIGIN_DESTINATION_YEAR_4char <- ORIGIN_DESTINATION_YEAR_4char[, c("year", "product", "group", "product_id", "group_id", "import_val", "export_val")]
            ...
            if(CHARACTERS == 6 | CHARACTERS == 8) {
                if(CHARACTERS == 6) {
                  ...
                  if(!file.exists(csv_file_6char) | !file.exists(json_file_6char)) {
                    ...
                    ORIGIN_all_YEAR_6char <- ORIGIN_all_YEAR_6char[, c("year", "product", "group", "product_id", "group_id", "import_val", "export_val")]
                    ...
                    all_all_YEAR_6char <- all_all_YEAR_6char[, c("year", "product", "group", "product_id", "group_id", "import_val", "export_val")]
                    ...
                    ORIGIN_DESTINATION_YEAR_6char <- ORIGIN_DESTINATION_YEAR_6char[, c("year", "product", "group", "product_id", "group_id", "import_val", "export_val")]
                ...
                if(CHARACTERS == 8) {
                  ...
                  if(!file.exists(csv_file_8char) | !file.exists(json_file_8char)) {
                    ...
                    ORIGIN_all_YEAR_8char <- ORIGIN_all_YEAR_8char[, c("year", "product", "group", "product_id", "group_id", "import_val", "export_val")]
                    ...
                    all_all_YEAR_8char <- all_all_YEAR_8char[, c("year", "product", "group", "product_id", "group_id", "import_val", "export_val")]
                    ...
                    ORIGIN_DESTINATION_YEAR_8char <- ORIGIN_DESTINATION_YEAR_8char[, c("year", "product", "group", "product_id", "group_id", "import_val", "export_val")]
