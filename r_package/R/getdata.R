        ...
        if(classification == "sitc") {
          if(characters == 4) {
            ...
            if(!file.exists(csv_file_4char) | !file.exists(json_file_4char)) {
              ...
              setnames(origin_destination_year_4char, names(origin_destination_year_4char), c("year", "origin_id", "destination_id", "sitc_rev2_product_code", "export_val", "import_val"))
              ...
              setnames(all_all_year_4char, names(all_all_year_4char), c("sitc_rev2_product_code","world_total_export_val","pci","pci_rank","top_exporter","top_importer"))
              ...
              setnames(origin_all_year_4char, names(origin_all_year_4char), c("sitc_rev2_product_code","origin_total_export_val"))

              origin_destination_year_4char <- join(origin_destination_year_4char, all_all_year_4char, by = "sitc_rev2_product_code")
              origin_destination_year_4char <- join(origin_destination_year_4char, origin_all_year_4char, by = "sitc_rev2_product_code")
              ...
              origin_destination_year_4char <- join(sitc_rev2_4char, origin_destination_year_4char, by = "sitc_rev2_product_code")
          ...
          if(characters == 6 | characters == 8) {
            if(characters == 6) {
              ...
              if(!file.exists(csv_file_6char) | !file.exists(json_file_6char)) {
                ...
                setnames(all_all_year_6char, names(all_all_year_6char), c("hs92_product_id","world_total_export_val","pci","pci_rank","top_exporter","top_importer"))
            ...
            if(characters == 8) {
              ...
              if(!file.exists(csv_file_8char) | !file.exists(json_file_8char)) {
                ...
                setnames(origin_destination_year_8char, names(origin_destination_year_8char), c("year", "origin_id", "destination_id", "hs92_product_id", "export_val", "import_val"))
                origin_destination_year_8char$trade_exchange_val <- rowSums(origin_destination_year_8char[, c("export_val", "import_val")], na.rm=T)
                origin_destination_year_8char$hs92_len <- nchar(origin_destination_year_8char$hs92_product_id)
                ...
                setnames(all_all_year_8char, names(all_all_year_8char), c("hs92_product_id","world_total_export_val","pci","pci_rank","top_exporter","top_importer"))
                ...
                setnames(origin_all_year_8char, names(origin_all_year_8char), c("hs92_product_id","origin_total_export_val"))

                origin_destination_year_8char <- join(origin_destination_year_8char, all_all_year_8char, by = "hs92_product_id")
                origin_destination_year_8char <- join(origin_destination_year_8char, origin_all_year_8char, by = "hs92_product_id")
                ...
                hs92_colors <- hs92_colors
                hs92_8char <- join(hs92_8char,hs92_colors, by="hs92_group_name")
                origin_destination_year_8char <- join(hs92_8char, origin_destination_year_8char, by = "hs92_product_id")
                rm(hs92_8char,hs92_colors)

                origin_destination_year_8char$hs92_icon <- paste0("d3plus-1.9.8/icons/hs92/hs92_", origin_destination_year_8char$hs92_group_id, ".png")
